...
- [ ] **Phase 6: TV Playback Experience Polish** - 打磨 TV 播放、空闲、异常、首次播放和远距离观看体验
- [ ] **Phase 7: Productized UI Polish** - 统一 Admin、Mobile、TV 的中文文案、状态反馈、视觉层级和关键交互
...
Plans:
- [ ] 06-01: 建立 TV 播放体验状态模型、文案和视觉验收基线
- [ ] 06-02: 实现 TV 空闲/播放/异常/首播提示和时间信息 UI 打磨
- [ ] 06-03: 补齐 TV 体验回归测试、响应式截图验证和真实浏览器 UAT 脚本
**UI hint**: yes
...
Plans:
- [ ] 07-01: 统一三端文案、状态术语、空/错/加载/成功反馈规范
- [ ] 07-02: 打磨 Mobile 和 Admin 的关键布局、按钮状态、刷新反馈和异常提示
- [ ] 07-03: 补齐 UI 回归测试和视觉检查脚本
**UI hint**: yes
...
|-------|----------------|--------|-----------|
| 6. TV Playback Experience Polish | 0/3 | Not started | - |
| 7. Productized UI Polish | 0/3 | Not started | - |
