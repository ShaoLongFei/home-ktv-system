...
- [x] **Phase 1: Media Contract & TV Runtime** - 建立受控媒体模型、切换契约和 TV 播放基础
- [x] **Phase 2: Library Ingest & Catalog Admin** - 让本地歌库可扫描、可审核、并按切换准入规则维护
- [x] **Phase 3: Room Sessions & Queue Control** - 交付扫码入场、多人控制、播放中切换和服务端权威队列
...
Plans:
- [x] 03-01: 建立房间入场与控制会话的持久化和共享契约
- [x] 03-02: 实现二维码配对、`pairingToken` 和控制会话生命周期
- [x] 03-03: 建立服务端权威队列命令契约与 Session Engine 基础
- [x] 03-04: 实现服务端权威队列命令、可点歌曲列表和 TV 播放结束推进
- [x] 03-05: 实现多控制端实时同步和房间快照广播
- [x] 03-06: 实现手机控制台扫码入场、队列控制和播放中控制
- [x] 03-07: 实现后台房间状态与入场令牌管理
- [x] 03-08: 实现 TV WebSocket 优先的房间状态同步闭环
**UI hint**: yes
...
|-------|----------------|--------|-----------|
| 1. Media Contract & TV Runtime | 3/3 | Complete | 2026-04-29 |
| 2. Library Ingest & Catalog Admin | 6/6 | Complete | 2026-04-30 |
| 3. Room Sessions & Queue Control | 8/8 | Complete | 2026-05-07 |
